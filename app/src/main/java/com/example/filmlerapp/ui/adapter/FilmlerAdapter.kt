...
class FilmlerAdapter(var mContext: Context, var filmlerListesi:List<Filmler>)
    ...
    override fun onBindViewHolder(holder: CardTasarimTutucu, position: Int) {//holder kartın üzerindeki nesnelere erişmemizi sağlıyor.position nesnelerin sıralaması
    ...
    override fun getItemCount(): Int { //kaç tane film göstereceğini belirt
